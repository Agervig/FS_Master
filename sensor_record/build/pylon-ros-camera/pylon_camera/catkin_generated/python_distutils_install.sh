...
echo_and_run cd "/home/agervig-pi/sensor_record/src/pylon-ros-camera/pylon_camera"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/agervig-pi/sensor_record/src/pylon-ros-camera/pylon_camera/setup.py" \
     \
    build --build-base "/home/agervig-pi/sensor_record/build/pylon-ros-camera/pylon_camera" \
    install \
    --root="${DESTDIR-/}" \
