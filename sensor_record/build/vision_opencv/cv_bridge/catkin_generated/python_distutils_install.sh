...
echo_and_run cd "/home/agervig-pi/sensor_record/src/vision_opencv/cv_bridge"
...
echo_and_run /usr/bin/env \
    ...
    egg_info --egg-base /home/agervig-pi/sensor_record/build/vision_opencv/cv_bridge \
    build --build-base "/home/agervig-pi/sensor_record/build/vision_opencv/cv_bridge" \
    install \
    --root="${DESTDIR-/}" \
