...
echo_and_run cd "/home/agervig-pi/sensor_record/src/vision_opencv/image_geometry"
...
echo_and_run /usr/bin/env \
    ...
    egg_info --egg-base /home/agervig-pi/sensor_record/build/vision_opencv/image_geometry \
    build --build-base "/home/agervig-pi/sensor_record/build/vision_opencv/image_geometry" \
    install \
    --root="${DESTDIR-/}" \
