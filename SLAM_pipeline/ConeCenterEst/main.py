...
def get_cone_centers():
    ...
    csv_path = "/home/agervig/git/FSM/MSc_Fstudent_SLAM/data/my_data/2/point_clouds"
    ...
    for file in sorted(os.listdir(csv_path), key=lambda x: int(x[:-4])): #Added by Thomas Agervig Jensen
        ...
        #f = open("/home/agervig/git/FSM/MSc_Fstudent_SLAM/data/old_data/final_test/cone_centers_airport_valid_lenscanline_timingtest.txt", "a")        #Contain x, y of cone center, label and a index dived by 4 for some reason (x,y,label, idx/4)
        f = open("/home/agervig/git/FSM/MSc_Fstudent_SLAM/data/my_data/2/final_test/cone_centers_airport_valid_lenscanline_timingtest_dataset1_new.txt", "a") 
        ...
        t = open("/home/agervig/git/FSM/MSc_Fstudent_SLAM/data/my_data/2/final_test/sync_timing_dataset1_new.txt", "a")
