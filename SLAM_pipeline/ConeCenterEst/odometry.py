...
def calculate_odometry_estimate(source_cloud, target_cloud):
    reg_p2p = o3d.pipelines.registration.registration_icp(
        source_cloud, target_cloud, max_correspondence_distance=0.2,
        estimation_method=o3d.pipelines.registration.TransformationEstimationPointToPoint(),
        criteria=o3d.pipelines.registration.ICPConvergenceCriteria(max_iteration=25000))
...
def main():
    ...
    cone_center_path = "/home/agervig/git/FSM/MSc_Fstudent_SLAM/data/my_data/1/experiments/cone_centers_airport_valid_lenscanline_timingtest.txt"
    #cone_center_path = "/home/agervig/git/FSM/MSc_Fstudent_SLAM/ConeCenterEst/experiments/cone_centers_airport_valid_lenscanline_timingtest.txt"
    ...
    for i in range(odometry_estimates)
        print(odometry_estimates)

    starting_position = np.eye(4)
    positions = apply_odometry_transformations(starting_position, odometry_estimates)

    print("SIZE OF POSITIONS: ", positions[0])
