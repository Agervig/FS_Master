...
model = UNet_7layers(n_channels=3, n_classes=5)

device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')

model.to(device=device)
model.load_state_dict(torch.load("models/104.pth", map_location=device))
...
img_path = '/home/agervig/git/FSM/MSc_Fstudent_SLAM/data/old_data/final_test/imgs_airport'
mask_path = '/home/agervig/git/FSM/MSc_Fstudent_SLAM/data/old_data/final_test/masks'
